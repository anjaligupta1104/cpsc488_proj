...
class FairFace(IATDataset):
    ...
    def __init__(self, iat_type: str = None, lazy: bool = True, mode: str = "train",
        ...
        if equal_split:
            ...
            self.labels = labels_male._append(labels_female, ignore_index=True)
            #self.labels = pd.concat([labels_male, pd.DataFrame(labels_female)], ignore_index=True)
    ...
    def download_data(self):
        ...
        fairface_parts = {
            "imgs": {
                "train_val": ("https://drive.google.com/u/0/uc?id=1g7qNOZz9wC7OfOhcPqH1EZ5bk1UFGmlL&export=download", "fairface-img-margin125-trainval.zip"),
            },
            "labels": {
